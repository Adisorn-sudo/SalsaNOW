            ...
            foreach (var ln in salsaNowIniOpen)
            {
                if (ln.Contains("NvidiaRaytracing = \"1\""))
                {
                    ...
                    try
                    {
                        ...
                        // setting the Power Management Mode to Prefer maximum performance, very important that this is applied on the base global profile so it covers every app/game launched
